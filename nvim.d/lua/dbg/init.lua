-- example: https://alpha2phi.medium.com/neovim-dap-enhanced-ebc730ff498b
...
utils.map('n', '<leader>dhu', '<cmd>lua require"dap.ui.widgets".hover()<CR>')
utils.map('n', '<leader>dfu',
