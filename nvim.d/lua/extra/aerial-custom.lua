-- Custom configuration for aerial.nvim

-- load aerial plugin
local ok, aerial = pcall(require, "aerial")
if not ok then
	vim.notify("[aerial-custom] aerial.nvim not found", vim.log.levels.WARN)
	return
end

-- Recommended configuration from aerial.nvim docs, adjust as needed
aerial.setup({
