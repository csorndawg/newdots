...
-- diffput
vim.keymap.set("n", "<leader>dp", ":diffput<Cr>", { desc = "Diffput", noremap = true })
vim.keymap.set("n", "<leader>dp2", ":diffput //2", { desc = "Diffput", noremap = true })
vim.keymap.set("n", "<leader>dp3", ":diffput //3", { desc = "Diffput", noremap = true })

-- diffget
vim.keymap.set("n", "<leader>dg", ":diffget <Cr>", { desc = "Diffget", noremap = true })
vim.keymap.set("n", "<leader>dg2", ":diffget //2", { desc = "Diffget", noremap = true })
vim.keymap.set("n", "<leader>dg3", ":diffget //3", { desc = "Diffget", noremap = true })
