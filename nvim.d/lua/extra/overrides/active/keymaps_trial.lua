...
map("n", "<leader>W", "<cmd>w!<CR>", opts) -- Save forcefully
map("n", "<leader>q", "<cmd>q<CR>", opts) -- Quit
map("n", "<leader>qq", "<cmd>q!<CR>", opts) -- Quit forcefully
map("n", "<leader><leader>q", "<cmd>q!<CR>", opts) -- Quit forcefully
map("n", "<leader>Q", "<cmd>q!<CR>", opts) -- Quit forcefully
map("n", "<leader>x", "<cmd>wq<CR>", opts) -- Save and quit
