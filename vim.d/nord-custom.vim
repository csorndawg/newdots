...
" create custom color swatch for visual mode selection 
" currently matches background color so I am unable to see whats seleected
let s:nord2_gui_original = "#434C5E"  " original swatch code
"let s:nord2_gui = "#434C5E"  ' original swatch code
let s:nord2_gui = "#6A7894"   " set nord2 gui to custom swatch for better visability with Visual mode
...
"call s:hi("Visual", "", s:nord2_gui_bright, "", s:nord1_term, "", "")
"call s:hi("VisualNOS", "", s:nord2_gui_bright, "", s:nord1_term, "", "")
